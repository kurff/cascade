 ...
 *
 * You should most likely not use the RegisDemangleTypetry class explicitly, but use the
...
class Registry {
 public:
  ...
  const std::map<SrcType, string>& HelpMessage() const {
 ...
 private:
  ...
  std::map<SrcType, string> help_message_;
